...
export interface PriceRealizationData {
  stats: {
    totalList: number;
    totalActual: number;
  ...
  outliers: { dealer: Dealer; avgDiscountPct: number; contracts: number }[];
}

export default function PriceRealizationClient({ data }: { data: PriceRealizationData }) {
