      ...
      .then(({ data, error }) => {
        if (error || !data) {
          ...
          setForm({
            ...
            qbo_deposit_income_item_id: data.qbo_deposit_income_item_id ?? "",
            qbo_deposit_income_item_name: data.qbo_deposit_income_item_name ?? "",
            qbo_deposit_liability_item_id: data.qbo_deposit_liability_item_id ?? "",
            qbo_deposit_liability_item_name: data.qbo_deposit_liability_item_name ?? "",
          });
        }
        setLoading(false);
            ...
            <CardContent className="p-4 space-y-3">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  ...
                  Configure both so flipping the flag requires no location changes.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <Input
                  ...
                  placeholder="e.g. Tyler Sales - Hot Tub Deposit"
                />
                <p className="text-xs text-slate-500">
                  Must be a QBO Item mapped to an <strong>Income</strong> account (matches Lori's current chart).
                </p>
              </div>
              ...
              <div className="border-t border-slate-200 pt-3 flex flex-col gap-1.5">
                ...
                <Input
                  ...
                  placeholder="e.g. Deposit - Tyler"
                />
                <p className="text-xs text-slate-500">
                  Must be a QBO Item mapped to the <strong>Customer Deposits</strong> liability sub-account for this location.
                </p>
              </div>
