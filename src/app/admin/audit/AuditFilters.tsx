...
const ALL_ACTIONS: { value: AuditAction | "all"; label: string }[] = [
  ...
  { value: "contract.submission_failed", label: "Submission Failed" },
  { value: "contract.recovered_by_lookup", label: "Recovered (Lookup)" },
  { value: "contract.idempotent_replay", label: "Idempotent Replay" },
  { value: "contract.signing_link_sent", label: "Signing Link Sent" },
  { value: "contract.remote_signed",     label: "Remotely Signed" },
